class Messaging
  ...
  checkLikeInfoMessaging: (model, callback) =>
    if MeetMikey.globalUser.checkLikeInfoMessaging()
      callback true
    else
      @showLikeInfoMessagingModal callback
  ...
  showLikeInfoMessagingModal: (callback) =>
    ...
    @likeInfoMessagingModal = new MeetMikey.View.LikeInfoMessagingModal el: '#mm-like-info-messaging-modal'
